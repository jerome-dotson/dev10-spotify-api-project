...
public class JwtConverter {
    ...
    //1. Signing key
    private Key key = Keys.secretKeyFor(SignatureAlgorithm.HS256); //generates a new key everytime it's instantiated
    ...
    public User getUserFromToken(String token) {
        ...
        try {
            ...
            Jws<Claims> jws = Jwts.parserBuilder()
                    ...
                    .setSigningKey(key)
                    .build()
                    .parseClaimsJws(token.substring(7)); //Set at 7 to account for "Bearer"
